...
ALTER TABLE orders ADD COLUMN created_by VARCHAR(50) NULL;
ALTER TABLE orders ADD COLUMN updated_by VARCHAR(50) NULL;
ALTER TABLE orders ADD COLUMN updated_date TIMESTAMP NULL;
